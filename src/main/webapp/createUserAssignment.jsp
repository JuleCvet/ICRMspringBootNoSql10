...
<title>Create a combination User and Assignment</title>
...
<jsp:include page="menu.jsp"/>
	...
	<div class="container">
    <form:form method="POST" modelAttribute="userAssignmentForm" class="form-signin">
        <h2 class="form-heading">Create User and Assignment</h2>
        ...
        <spring:bind path="assignmentId">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="assignmentId" class="form-control" placeholder="Assignment-Id"></form:input>
